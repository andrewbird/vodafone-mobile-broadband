...
VMB_MODEM_STATE_UNKNOWN = MM_MODEM_STATE_UNKNOWN       #  0
VMB_MODEM_STATE_NODEVICE = MM_MODEM_STATE_UNKNOWN + 1
VMB_MODEM_STATE_HAVEDEVICE = MM_MODEM_STATE_UNKNOWN + 2
VMB_MODEM_STATE_DISABLED = MM_MODEM_STATE_DISABLED     # 10
VMB_MODEM_STATE_DISABLING = MM_MODEM_STATE_DISABLING   # 20
VMB_MODEM_STATE_LOCKED = MM_MODEM_STATE_DISABLING + 1
VMB_MODEM_STATE_UNLOCKING = MM_MODEM_STATE_DISABLING + 2
VMB_MODEM_STATE_UNLOCKED = MM_MODEM_STATE_DISABLING + 3
VMB_MODEM_STATE_ENABLING = MM_MODEM_STATE_ENABLING     # 30
VMB_MODEM_STATE_ENABLED = MM_MODEM_STATE_ENABLED
VMB_MODEM_STATE_SEARCHING = MM_MODEM_STATE_SEARCHING
VMB_MODEM_STATE_REGISTERED = MM_MODEM_STATE_REGISTERED
VMB_MODEM_STATE_DISCONNECTING = MM_MODEM_STATE_DISCONNECTING
VMB_MODEM_STATE_CONNECTING = MM_MODEM_STATE_CONNECTING
VMB_MODEM_STATE_CONNECTED = MM_MODEM_STATE_CONNECTED

VMB_SIM_AUTH_NONE, VMB_SIM_AUTH_PIN, \
VMB_SIM_AUTH_PUK, VMB_SIM_AUTH_PUK2 = range(4)

VMB_VIEW_DISABLED, VMB_VIEW_IDLE, VMB_VIEW_BUSY = range(3)
